...
Zixuan Peng, Shikha Asharan, Keegan Fitzpatrick, Em McNeil

## Communication

Communication will occur via outlook email and an imessage groupchat when not in person.
In person times to meet up will include at least 1 hour on thursdays at 4pm and if needed
an hour on Tuesdays from 3-4pm may also be used. 
  

## Question of Interest
  
  The question of interest we will be exploring is whether there is a positive lienar relationsip between trump vote share and hate crime rate ammong the sample of U.S. states.

## Data and Description

Source: https://github.com/fivethirtyeight/data/blob/master/hate-crimes/README.md
Columns of interest: Hate crime rate by state - SPLC or FBI
...
We will be using simple linear regression of hate_crime_rate on trump_vote_share.
